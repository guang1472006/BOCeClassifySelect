...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BOCeClassifySelect.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/734781246@qq.com/BOCeClassifySelect'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '734781246@qq.com' => '734781246@qq.com' }
  s.source           = { :git => 'https://github.com/734781246@qq.com/BOCeClassifySelect.git', :tag => s.version.to_s }
